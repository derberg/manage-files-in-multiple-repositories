...
sleep_pr_creation | Sleep time in seconds between processing each pull request. Useful to avoid overwhelming CI/CD pipelines with too many PRs created at once. Set to 0 to disable sleep. | false | 0
