...
async function run() {
  if (process.env.GITHUB_EVENT_NAME !== 'push' && process.env.GITHUB_EVENT_NAME !== 'workflow_dispatch') return core.setFailed('This GitHub Action works only when triggered by "push" webhook.');
